...
async function main() {
    ...
    const adminPassword = await bcryptjs_1.default.hash(process.env.SEED_ADMIN_PASSWORD || "Admin@12345", 12);
    const userPassword = await bcryptjs_1.default.hash("Student@12345", 12);
    ...
    const coursesData = [
        {
            ...
            description: "Master Next.js 14+ with App Router, Server Components, authentication, and deployment. Build production-grade apps from scratch.",
        ...
        },
        {
            ...
            description: "Go beyond basics: generics, utility types, strict mode, and architectural patterns for large-scale TypeScript codebases.",
        ...
        },
        {
            ...
            description: "Learn pandas, NumPy, matplotlib, and scikit-learn. Analyze real datasets and build predictive models.",
        ...
        },
        {
            ...
            description: "Build cross-platform mobile apps with React Native, Expo, and native device APIs.",
        ...
        },
        {
            ...
            description: "Create beautiful, accessible interfaces. Learn color theory, typography, Figma workflows, and design systems.",
        ...
        },
        {
            ...
            description: "Containerize applications, orchestrate with Kubernetes, and implement CI/CD pipelines on cloud platforms.",
